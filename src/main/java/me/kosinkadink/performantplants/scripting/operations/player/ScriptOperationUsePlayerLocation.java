...
public class ScriptOperationUsePlayerLocation extends ScriptOperationPlayer {

    public ScriptOperationUsePlayerLocation(ScriptBlock scriptBlock) {
        super(scriptBlock);
    }
    ...
    public ScriptResult perform(@Nonnull ExecutionContext context) throws IllegalArgumentException {
        ...
        if (context.isPlayerSet()) {
            context.setLocation(context.getPlayer().getLocation());
        }

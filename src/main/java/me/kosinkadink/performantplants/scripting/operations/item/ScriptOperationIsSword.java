...
public class ScriptOperationIsSword extends ScriptOperationItemInputs {

    public ScriptOperationIsSword(ScriptBlock itemStack) {
        super(itemStack);
    }
    ...
    public ScriptResult perform(@Nonnull ExecutionContext context) throws IllegalArgumentException {
        ...
        return new ScriptResult(ItemHelper.isMaterialSword(itemStack));
    }

...
public class ScriptOperationPowerOf extends ScriptOperationPower {
    ...
    public ScriptOperationPowerOf(ScriptBlock left, ScriptBlock right) {
        super(left, right);
    }
    ...
    protected void validateInputs() {
        ...
        if (getLeft().getType() == ScriptType.BOOLEAN) {
            throw new IllegalArgumentException("Left argument cannot be ScriptType BOOLEAN for PowerOf operation");
        }
    }

...
public class ScriptOperationItemGetMaterial extends ScriptOperationItemInputs {

    public ScriptOperationItemGetMaterial(ScriptBlock itemStack) {
        super(itemStack);
    }
    ...
    public ScriptResult perform(@Nonnull ExecutionContext context) throws IllegalArgumentException {
        ...
        return new ScriptResult(itemStack.getType().toString());
    }

...
public class ScriptOperationTakeOne extends ScriptOperationItemInputs {

    public ScriptOperationTakeOne(ScriptBlock itemStack) {
        super(itemStack);
    }
    ...
    public ScriptResult perform(@Nonnull ExecutionContext context) throws IllegalArgumentException {
        ...
        return new ScriptResult(ItemHelper.decrementItemStack(itemStack));
    }

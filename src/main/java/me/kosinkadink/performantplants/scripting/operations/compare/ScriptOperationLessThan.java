...
public class ScriptOperationLessThan extends ScriptOperationCompare {

    public ScriptOperationLessThan(ScriptBlock left, ScriptBlock right) {
        super(left, right);
    }
    ...
    protected void validateInputs() {
        ...
        if (getLeft().getType() == ScriptType.BOOLEAN || getRight().getType() == ScriptType.BOOLEAN) {
            throw new IllegalArgumentException("LessThan operation does not support ScriptType BOOLEAN");
        }
    }

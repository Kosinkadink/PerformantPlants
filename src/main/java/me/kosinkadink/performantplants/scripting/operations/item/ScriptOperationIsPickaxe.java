...
public class ScriptOperationIsPickaxe extends ScriptOperationItemInputs {

    public ScriptOperationIsPickaxe(ScriptBlock itemStack) {
        super(itemStack);
    }
    ...
    public ScriptResult perform(@Nonnull ExecutionContext context) throws IllegalArgumentException {
        ...
        return new ScriptResult(ItemHelper.isMaterialPickaxe(itemStack));
    }

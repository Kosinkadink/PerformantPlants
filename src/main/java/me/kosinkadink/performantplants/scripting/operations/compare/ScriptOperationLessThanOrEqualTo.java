...
public class ScriptOperationLessThanOrEqualTo extends ScriptOperationCompare {

    public ScriptOperationLessThanOrEqualTo(ScriptBlock left, ScriptBlock right) {
        super(left, right);
    }
    ...
    protected void validateInputs() {
        ...
        if (getLeft().getType() == ScriptType.BOOLEAN || getRight().getType() == ScriptType.BOOLEAN) {
            throw new IllegalArgumentException("LessThanOrEqualTo operation does not support ScriptType BOOLEAN");
        }
    }

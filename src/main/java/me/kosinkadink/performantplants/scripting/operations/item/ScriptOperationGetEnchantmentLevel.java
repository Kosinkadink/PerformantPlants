...
public class ScriptOperationGetEnchantmentLevel extends ScriptOperationItem {

    public ScriptOperationGetEnchantmentLevel(ScriptBlock itemStack, ScriptBlock enchantment) {
    ...
    public ScriptResult perform(@Nonnull ExecutionContext context) throws IllegalArgumentException {
        ...
        return new ScriptResult(itemStack.getEnchantmentLevel(enchantment));
    }

...
public class ScriptOperationIsAxe extends ScriptOperationItemInputs {

    public ScriptOperationIsAxe(ScriptBlock itemStack) {
        super(itemStack);
    }
    ...
    public ScriptResult perform(@Nonnull ExecutionContext context) throws IllegalArgumentException {
        ...
        return new ScriptResult(ItemHelper.isMaterialAxe(itemStack));
    }

...
public class ScriptOperationMultiplyBy extends ScriptOperationMultiply {

    public ScriptOperationMultiplyBy(ScriptBlock left, ScriptBlock right) {
        super(left, right);
    }
    ...
    protected void validateInputs() {
        ...
        if (getLeft().getType() == ScriptType.BOOLEAN) {
            throw new IllegalArgumentException("Left argument cannot be ScriptType BOOLEAN for MultiplyBy operation");
        }
    }

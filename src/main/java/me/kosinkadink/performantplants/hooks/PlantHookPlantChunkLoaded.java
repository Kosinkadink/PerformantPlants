...
public class PlantHookPlantChunkLoaded extends PlantHookPlantChunk {

    public PlantHookPlantChunkLoaded(UUID taskId, HookAction action, String hookConfigId, ChunkLocation chunkLocation) {
        super(taskId, action, hookConfigId, chunkLocation);
    }

    public PlantHookPlantChunkLoaded(UUID taskId, HookAction action, String hookConfigId, String jsonString) throws PlantHookJsonParseException {
